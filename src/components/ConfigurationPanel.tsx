...
import { Settings, Key, MessageSquare, Database, Bot, Save, TestTube, CheckCircle, AlertTriangle } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Configure as integrações para análise automática de cotações
        </p>
      </div>
